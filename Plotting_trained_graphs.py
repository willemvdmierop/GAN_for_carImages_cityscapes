...
df = pd.read_csv("Metrics_GAN/Metrics_ResNet34_cropped_gradclip.csv")
...
ax[0].plot(x,df['FID'], '-+', color = 'red', label = 'ResNet34 with gradient clipping')
...
ax[0].grid()
ax[1].plot(x,df['Inception Score'], '-+',color = 'red', label = 'ResNet34 with gradient clipping')
