...
if not os.path.exists(wd + '/gen_images_v07_gr_DCGAN'):
    os.mkdir(wd + '/gen_images_v07_gr_DCGAN')
...
for e in range(epochs, num_epochs):
    ...
    if e % 100 == 0:
        ...
        for i in range(5):
            if not os.path.exists(wd + "/gen_images_v07_gr_DCGAN/" + "hallucinated_" + str(e)):
                os.mkdir(wd + "/gen_images_v07_gr_DCGAN/" + "hallucinated_" + str(e))
            ...
            plt.imshow(out)
            filename = wd + "/gen_images_v07_gr_DCGAN/" + "hallucinated_" + str(e) + "/generated_" + str(i) + ".png"
