...
Original file is located at
    https://colab.research.google.com/drive/1jB8htaUmqaOWtC5GGf2bpMGaRNtmguAp
"""
...
ndf = 64
num_epochs = 1500
path_img = os.path.join(wd,"cars5")
...
for e in range(num_epochs):
    for id, data in dataloader:
        ...
        optimizerG.step()  
    if e % 50 == 0:
        torch.save(g.state_dict(), os.path.join(wd, 'car_generator_GAN_intermediate_3500.pth'))
        torch.save(d.state_dict(), os.path.join(wd, 'car_discriminator_GAN_intermediate_3500.pth'))
        print("saved intermediate weights")
torch.save(g.state_dict(), os.path.join(wd, 'car_generator_GAN_3500.pth'))
torch.save(d.state_dict(), os.path.join(wd, 'car_discriminator_GAN_3500.pth'))
