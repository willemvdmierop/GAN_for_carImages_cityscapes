...
for e in range(num_epochs):
	...
	if e > 1000:
		if e%250 == 0:
			torch.save(g.state_dict(), os.path.join(checkpoints, 'G_lr-3_wd-3_{}e_green_orthwinitnreg_hinge.pth' .format(e)))
			torch.save(d.state_dict(), os.path.join(checkpoints, 'D_lr-3_wd-3_{}e_green_orthwinitnreg_hinge.pth' .format(e)))

tb.close()
torch.save(g.state_dict(), os.path.join(checkpoints, 'G_lr-3_wd-3_3ke_green_orthwinitnreg_hinge.pth'))
torch.save(d.state_dict(), os.path.join(checkpoints, 'D_lr-3_wd-3_3ke_green_orthwinitnreg_hinge.pth'))